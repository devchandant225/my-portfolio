  ...
  useEffect(() => {
    ...
    function scrollFunction() {
      if (
        ...
        document.getElementById("scrolldown_nav").style.top = "0";
      } else {
        document.getElementById("scrolldown_nav").style.top = "-100px";
      }
    }
  });
  return (
...
export default ScrolldownNavigation;
